...
class cA5(object):
    ...
    def __init__(self, numpy_rng, theano_rng=None, input=None, n_visible=784, n_hidden=100,
...
def test_cA(learning_rate=0.01, training_epochs=20,
            dataset='mnist_subset1', #           dataset='mnist.pkl.gz',
    ...
    from load_MFC7_data2 import load_dataset
    datasets = load_dataset(dataset,reduce=2,samples=None, frac=None, rng_seed=None)
...
#             tile_spacing=(1, 1)))
# 
#         image.save('cae_filters'+str(epoch)+'.png')
