...
def exe(target_dataset,compound_label, dir, cost, kernel):
    print "Running libsvm for the bbbc data ...";
    if target_dataset == 'MFC7_set1':
        path = "/home/aditya/store/Datasets/libsvm_data2/MFC7_set1/"
    elif target_dataset == 'MFC7_set2':
        path = "/home/aditya/store/Datasets/libsvm_data2/MFC7_set2/"
    ...
    #execute1 = "./svm_multiclass_learn", "-c", cost, "-t", kernel, "-d", "3", path+FNAME, MODEL
...
for target_dataset in target_datasets:
    if target_dataset == 'MFC7_set1':
        ...
        for idx, compound_label in enumerate(compound_items):
            ...
            mtest_errors, train_time, train_error = exe(target_dataset,compound_label, dir, cost, kernel)
    ...
    output_file_path = results_dir +target_dataset+"/"+'outputs_'+timestamp+'_%03d.pkl.gz' % (repetition+1)
    ...
    f3 = open(results_dir+target_dataset+"/"+target_dataset +"_results.txt",'a')
    old_stdout = sys.stdout   
    sys.stdout = f3
    print '*'*30 
    print '*'*30 
