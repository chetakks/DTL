...
def plot_cm(m,mean_accu, std_accu, target_outputs_dir, rep, type_of_cm,labels, approach=None,target_dataset=None,source_dataset=None ):
    print 'avg cms'
    ...
    if type_of_cm == 'per_repeatation':
        ...
        plt.savefig(target_outputs_dir+type_of_cm+str(rep)+'cm.png',bbox_inches='tight',dpi=200)
    elif type_of_cm == 'average':
        plt.savefig(target_outputs_dir+type_of_cm+'_cm.png',bbox_inches='tight',dpi=200)
    plt.close(fig)