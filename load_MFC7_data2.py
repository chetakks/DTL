...
def unpack_MFC7_gzip_data(data_path,fold, data_name, rng_seed,frac,two_cl = None):
#     #if data_name == 'MFC7_set1+set2':
#     compound_label = data_name[12:]
#     print 'compound_label', compound_label
    
 
    compound_label = data_name[10:]
    print 'compound_label', compound_label
...
#         fold = 'MFC7/loov3_new/'
#         #fold = 'MFC7/loov4_new/'
#         #fold = 'MFC7/loov_per_feature_norm2/'
#         #fold = 'MFC7/loov_class/'
#     elif two_cl == 2:
#         fold = 'MFC7/loov_PD_PS2/'
#     
#     #fold = 'MFC7/loov_with_per_treatment/'
#     #fold = 'MFC7/loov_with_per_treatment_valid/'
#     #fold = 'MFC7/loov_with_per_treatment_valid2/'
#     #fold = 'MFC7/loov_with_per_treatment_valid_moa/'
    ...
    train_set = shuffel(train_set,rng_seed,frac)
    valid_set = shuffel(valid_set,rng_seed,frac)
    
    #path = '/home/aditya/store/Datasets/pickled/MFC7/ljosa_data/'
    #if data_name == 'MFC7_set1+set2':
    #treatment_items =load(data_path+data_name[0:11]+'_treatment_items.pkl.gz')
    #else:
    treatment_items =load(data_path+data_name[0:9]+'_treatment_items.pkl.gz')
    #treatment_items = load(path+'treatment_items.pkl')
...
#     
#     if compound_label == 'mevinolin':
#         nc_treatment_items[0:,0] = [s.replace('mevinolin/lovastatin', 'mevinolin') for s in nc_treatment_items[0:,0]]
        #compound_label = 'mevinolin/lovastatin'
    #print 'treatment_items', treatment_items[0:,0]
    treatments = np.where(treatment_items[0:,0] == compound_label )
    print treatments
    print 'treaments for the compoud:'
    print treatment_items[treatments]
    
    #host_path = os.getenv('HOME')
    #data_path=host_path+'/store/Datasets/pickled/MFC7/loov_with_per_treatment_valid_moa/'

    idst = treatments[0][0]
    print idst
    #if data_name == 'MFC7_set1+set2':
    #f1  = data_name[0:12]+treatment_items[idst][0]+'_'+str(treatment_items[idst][1])+'_test.pkl.gz'
    #else:
    f1  = data_name[0:10]+treatment_items[idst][0]+'_'+str(treatment_items[idst][1])+'_test.pkl.gz'
    ...
    print 'Train set: ', data_name+'_train.pkl.gz'
    print 'Valid set: ', data_name+'_valid.pkl.gz'
    print 'Test set : ', f1
    print 'done loading'
...
def unpack_data_target(data_path,data_name):
    ...
    train_set_1 = cPickle.load(f)# ### Change class 11 to 12
# print np.unique(non_control_cell_metadata[0:,3])
# old_cl = 12
# new_cl = 16
# a = non_control_cell_metadata[0:,3][non_control_cell_metadata[0:,3] == old_cl]
# a.fill(new_cl)
# b = np.where(non_control_cell_metadata[0:,3] == old_cl)
# c = non_control_cell_metadata[0:,3]
# c[b] = a
# non_control_cell_metadata[0:,3] = c
# print np.unique(non_control_cell_metadata[0:,3])
    f.close()
...
def load_multi_test_dataset(data_name,data_path, fold, two_cl = None ):
...
#     data_path=host_path+'/store/Datasets/pickled/MFC7/loov/'
#     data_path=host_path+'/store/Datasets/pickled/MFC7/loov2/'
#     data_path=host_path+'/store/Datasets/pickled/MFC7/loov3/'
#     #data_path=host_path+'/store/Datasets/pickled/MFC7/loov4/'
#     #data_path=host_path+'/store/Datasets/pickled/MFC7/loov5/'
#     #data_path=host_path+'/store/Datasets/pickled/MFC7/loov6/'
#     #data_path=host_path+'/store/Datasets/pickled/MFC7/loov7/'
#     #data_path=host_path+'/store/Datasets/pickled/MFC7/loov8/'
#     data_path=host_path+'/store/Datasets/pickled/MFC7/loov9/'
#     if two_cl == None:
#         #data_path=host_path+'/store/Datasets/pickled/MFC7/loov9a/'
#         data_path=host_path+'/store/Datasets/pickled/MFC7/loov3/'
#         data_path=host_path+'/store/Datasets/pickled/MFC7/loov3_new/'
#         #data_path=host_path+'/store/Datasets/pickled/MFC7/loov4_new/'
#         #data_path=host_path+'/store/Datasets/pickled/MFC7/loov_per_feature_norm2/'
#         #data_path=host_path+'/store/Datasets/pickled/MFC7/loov_class/'
#     elif two_cl == 2:
#         data_path=host_path+'/store/Datasets/pickled/MFC7/loov_PD_PS2/'
#         
    
    #data_path=host_path+'/store/Datasets/pickled/MFC7/loov_with_per_treatment_valid/'
    #data_path=host_path+'/store/Datasets/pickled/MFC7/loov_with_per_treatment_valid2/'
    #data_path=host_path+'/store/Datasets/pickled/MFC7/loov_with_per_treatment_valid_moa/'

    multi_test_sets = []
    multi_test_labels = []
    for ids in  range(len(np.array(treatments)[0])):
    #for ids in treatments:
...
def load_dataset(data_name, data_path, fold, reduce=None,samples=None, frac=None, rng_seed=None):
    ''' Loads the dataset
    :type dataset: string
    ...
    if reduce == None:
        ...
        train_set, valid_set, test_set = unpack_MFC7_gzip_data(data_path,fold,data_name,rng_seed,frac)
        proportion_of_classes(train_set, valid_set, test_set)
    elif reduce == 7:
        train_set, valid_set, test_set = unpack_MFC7_gzip_data(data_path,fold, data_name,rng_seed,frac,two_cl=2)
        proportion_of_classes(train_set, valid_set, test_set)
